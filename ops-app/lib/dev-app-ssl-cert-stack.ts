...
const AUDITRE_CO_PARENT_ZONE_ID = 'Z07568843L6OVLOAM2W4';

export class DevAppSSLCertStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const cert = new acm.Certificate(this, 'CICert', {
      domainName: `ci.${domainName}`,
      subjectAlternativeNames: [`*.ci.${domainName}`],
